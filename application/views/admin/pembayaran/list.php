                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-outline-primary" href="<?php echo site_url('admin/pembayaran/edit/') . $Get->id_pembayaran ?>">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    Edit
                                </a>
                                <a class="btn btn-outline-danger" onclick="return deleteConfirm('<?php echo site_url('admin/pembayaran/delete/') . $Get->id_pembayaran ?>')" href="#!">

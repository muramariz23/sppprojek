...
<form action="" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control <?php echo form_error('tgl_bayar') ? 'is-invalid' : '' ?>" id="staticEmail" name="tgl_bayar" value="<?php echo $GetPembayaran->tgl_bayar; ?>" required>
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control <?php echo form_error('bulan_bayar') ? 'is-invalid' : '' ?>" id="staticEmail" name="bulan_bayar" value="<?php echo $GetPembayaran->bulan_bayar; ?>" required>
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control <?php echo form_error('tahun_bayar') ? 'is-invalid' : '' ?>" id="staticEmail" name="tahun_bayar" value="<?php echo $GetPembayaran->tahun_bayar; ?>" required>
                                        </div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control <?php echo form_error('jumlah_bayar') ? 'is-invalid' : '' ?>" id="staticEmail" name="jumlah_bayar" value="<?php echo $GetPembayaran->jumlah_bayar; ?>" required>
                                        </div>
                                        <div class="invalid-feedback">
